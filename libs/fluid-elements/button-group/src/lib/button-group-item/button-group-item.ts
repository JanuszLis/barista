...
export class FluidButtonGroupItem extends LitElement {
  ...
  static get styles(): CSSResult {
    return css`
      ...
      :host([disabled]) .fluid-svg-radio-button {
        opacity: 0.5;
      }
      ...
      .fluid-svg-radio-button {
        cursor: pointer;
        height: 18px;
        fill: transparent;
      }

      .fluid-svg-radio-button:not(.fluid-state--tabbed) {
        outline: none;
      }

      .fluid-button-group-item:hover .fluid-svg-radio-button-circle {
        fill: var(--fluid-button-group-item--radio-hover-color);
        opacity: 1;
      }

      .fluid-svg-radio-button:focus .fluid-svg-radio-button-circle {
        fill: var(--fluid-button-group-item--radio-hover-color);
        opacity: 1;
      }

      .fluid-state--checked .fluid-svg-radio-button-circle {
      ...
      .fluid-button-group-item:hover
        .fluid-state--checked
        .fluid-svg-radio-button-circle {
        fill: var(--fluid-button-group-item--radio-active-color);
        opacity: 1;
      }

      .fluid-state--checked.fluid-svg-radio-button:focus
        .fluid-svg-radio-button-circle {
        fill: var(--fluid-button-group-item--radio-active-color);
        opacity: 1;
      }
      ...
      .fluid-label.fluid-state--checked-label {
        font-weight: bold;
        padding: 0;
      }
  ...
  render(): TemplateResult {
    const svgClassMapData = {
      'fluid-svg-radio-button': true,
      'fluid-state--tabbed': this.tabbed,
      'fluid-state--checked': this.checked,
      'fluid-state--disabled': this.disabled,
    };

    const labelClassMapData = {
      'fluid-state--checked-label': this.checked,
      'fluid-label': true,
      'fluid-button-group-item-wrapper': true,
    };
        ...
        /><label class="fluid-button-group-item-label" for="${this.id}">
          ...
          >
            <g transform="translate(5, 10)">
              <circle class="fluid-svg-radio-button-circle" r="3.5" />
            </g>
          </svg>
          <span class=${classMap(labelClassMapData)}>
            <slot></slot>
          </span>
        </label>
      </div>
