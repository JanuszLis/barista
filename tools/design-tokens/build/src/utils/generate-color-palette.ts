...
export function generateColorPalette(
  ...
  const colorFile = aliasesEntrypoints.find((file) =>
    file.endsWith('palette-source.alias.yml'),
  )!;

  return from(fs.readFile(colorFile, { encoding: 'utf-8' })).pipe(
