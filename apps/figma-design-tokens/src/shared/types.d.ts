...
type MessageType = 'fetch-tokens-request' | 'fetch-tokens-response'
  | 'upload-style-metadata-request' | 'upload-style-metadata-response' | 'upload-style-metadata-userinterrupted'
  | 'fetch-style-metadata-request' | 'fetch-style-metadata-response';
...
interface FetchTokensResponseMessage extends IPCResponseMessage<TokenStoreModel> {
  type: 'fetch-tokens-response';
}

interface UploadStyleMetadataRequestMessage extends IPCRequestMessage<StyleMetadataCollection> {
...
interface FetchStyleMetadataResponseMessage extends IPCResponseMessage<StyleMetadataCollection> {
