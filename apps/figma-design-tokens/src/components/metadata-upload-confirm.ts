...
import '@dynatrace/fluid-button'
import '@dynatrace/fluid-checkbox'
import { FluidCheckboxChangeEvent } from '@dynatrace/fluid-checkbox';
    ...
    if (this._publishing) {
      ...
      return html`
        ...
        <ul>
          ...
          <li>
            <em>all</em> the design tokens have been synchronized and show up as styles in
            the right bar.
          </li>
        </ul>
        <strong>
          This will overwrite the current remote style data,
          so wrong data would causing theme switching to break everywhere.
          If the design tokens have changed, you'll also have to publish the
          Figma library (you can do this after running this after clicking "Upload").
        </strong>

        <p>
          <fluid-checkbox id="acknowledge-check" @change="${this._handleAcknowledgeChange}" />
        ...
        <div>
          <fluid-button
            ...
            emphasis="high">Upload</fluid-button>
